      ...
      <div className="contact-container">
        <div className="contact-card">
          ...
          <div className="contact-item">
            ...
            <div>
              <h3>Mail</h3>
              <p><a href="mailto:hr@msrscorp.com">hr@msrscorp.com</a></p>
            </div>
          </div>
          <div className="contact-item">
            ...
            <div>
              <h3>Location</h3>
              <p>
                Hall No# 2, 4th Floor, Metro House, Plot No- A/410, Vani Vihar
                Square, Saheed Nagar, Bhubaneswar, Odisha-751007, India
              </p>
            </div>
          </div>
        </div>
